...
function exibirMensagem(){
    console.log('(D2-Q01)  Olá, mundo!');
}
exibirMensagem();
//2. Criar uma função que recebe um nome como parâmetro e exibe "Olá, [nome]!" no console.
function exibirNome(nome){
    console.log(`(D2-Q02)) Olá, ${nome}!`);
}
exibirNome('Jairo');
//3. Criar uma função que recebe um número como parâmetro e retorna o dobro desse número.
function calcularNumero(numero) {
    return console.log(`(D2-Q03) Dobro de ${numero} = ${(numero*2)}`);
}
calcularNumero(10);
//4. Criar uma função que recebe três números como parâmetros e retorna a média deles.
function calcularMedia(num1, num2, num3){
    let media = parseFloat((num1 + num2 + num3)/3);
    return console.log(`(D2-Q04) Média dos números (${num1}, ${num2}, ${num3}) = ${media}`);
}
...
function exibirMaiorNumero(num1, num2) {
    ...
    return console.log(`(D2-Q05) ${maior}`);
}
exibirMaiorNumero(5, 3);
//6. Criar uma função que recebe um número como parâmetro e retorna o resultado da multiplicação desse número por ele mesmo
function multiplicarNumero(num1){
    return console.log(`(D2-Q06) ${num1} ao quadrado = ${num1*num1}`);
}
